...
Scene* DL::createScene()
{
	// 'scene' is an autorelease object
	auto scene = Scene::create();

	// 'layer' is an autorelease object
	auto layer = DL::create();
...
bool DL::init()
{
	...
	bg->setScaleY(2);*/
	bg->setScale(2);
	//bg->setContentSize(bg->getContentSize() * 2);
	...
	bgMM->setPosition(Vec2(visibleSize.width / 2.0f + 20 * visibleSize.width / 960, visibleSize.height / 2.0f - 40 * visibleSize.width / 960));
	addChild(bgMM, 2);
	...
	//textFieldAccount->setTextHorizontalAlignment();
	...
	textFieldAccount->addEventListener(CC_CALLBACK_2(DL::textFieldEvent, this));
	...
	textFieldPassword->setPosition(Vec2(visibleSize.width / 2.0f + 20, visibleSize.height / 2.0f - 40));
	textFieldPassword->addEventListener(CC_CALLBACK_2(DL::textFieldEvent1, this));
	...
	MenuItemSprite* buttonQX = MenuItemSprite::create(nqSprite, sqSprite, [&](Ref* sender) {
		...
		/*auto temp = getParent()->getChildByTag(2);*/getParent()->removeChildByTag(10);
...
void DL::textFieldEvent(Ref *pSender, TextField::EventType type)
{
	switch (type)
	{
...
void DL::textFieldEvent1(cocos2d::Ref * pSender, cocos2d::ui::TextField::EventType type)
{
	switch (type)
	{
	case TextField::EventType::ATTACH_WITH_IME:
...
cocos2d::Sprite * DL::makeButton(std::string name, std::string bgSprite)
{
